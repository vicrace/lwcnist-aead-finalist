...
#define MAX_MESSAGE_LENGTH 64											// Maximum message length
#define MAX_ASSOCIATED_DATA_LENGTH 0									// Max AD length
...
#define CHECKRESULT
//#define PRINT
//#define DEBUGGPU														// Debug for GPU only, thread 0 & 1														
//#define PRINTC														//print ct
