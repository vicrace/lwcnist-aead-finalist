...
//#define PRINT
//#define PRINTC
#define BATCH  16000000	//64000 for faster testing
#define ROMULUS_VER "N"			//version M - M1 nonce misuse-resistant , N - N1 nonce-based secure, T - leakage resillience AE mode
//#define WRITEFILE
